...
- [ ] 05-05-PLAN.md — Gap closure: fix CSS build @import resolution (inline _compat.css into Tailwind input + append basecoat.css post-compile) + regression test + 3 operator-doc footgun warnings (UI-01, UI-02)
**UI hint**: yes
